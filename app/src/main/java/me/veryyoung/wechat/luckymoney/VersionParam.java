...
public class VersionParam {
    ...
    public static String networkRequest = "com.tencent.mm.model.an";
    public static String getNetworkByModelMethod = "uC";
    public static String getMessageClass = "com.tencent.mm.e.b.ca";
